        ...
        <>
            ...
            <div className="App ">
                ...
                <div className="main-content min-h-screen flex flex-col items-center justify-center text-gray-900">
                    ...
                    <header className="hero-section text-[#fff]" id="home">
                        <p className='text-[20px] break-words' >Powering trustless settlement vs trust-minized verification on Bitcoin at 99% lower cost for all Layers & Apps</p>
                    ...
                    <section className="about-section px-4 min-h-screen  mb-300px" id="about">
                        <div className="about-container max-w-6xl mx-auto text-center">
                            ...
                            <div className="about-container-text mt-4">
                                <p className="about-text break-words text-gray-700">
                    ...
                    {/* Phần hệ sinh thái */}
                    <section className="ecosystem-section text-[#fff]" id="ecosystem">
                        <h2>Our Ecosystem</h2>
                        <p>Bringing together developers, enterprises, and Bitcoin enthusiasts.</p>
                    </section>

                    {/* Footer */}
                    <footer className="footer text-[#fff]">
